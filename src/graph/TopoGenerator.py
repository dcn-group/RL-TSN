...
from src.graph.Strategy.topo_strategy.ErdosRenyiStrategy import ErdosRenyiStrategy
from src.graph.Strategy.topo_strategy.TopoStrategy import TopoStrategy
from src.type import NodeId
from src.graph.computing import softmax
...
class TopoGenerator(object):
    ...
    def attach_edge_nodes(self, graph: nx.Graph, n: int):
        '''
